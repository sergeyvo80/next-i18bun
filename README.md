...
Реализованы апи-заглушки
- src/app/api/login
- src/app/api/logout

Проверки доступов в src/proxy.ts
...
Так же предусмотрены темная/светлая тема которая применяется в зависимости от установленной темы в системе.
